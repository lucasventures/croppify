...
public class ResultDisplay extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ImageButton keep = (ImageButton) findViewById(R.id.Continue);
		ImageButton back = (ImageButton) findViewById(R.id.goback);
		Uri imUri = getIntent().getParcelableExtra("imageUri");
		ImageView mImageView = (ImageView) findViewById(R.id.cropDisplay);
	...
	public void onClick(View v) {
         ...
         case R.id.goback:
        	 ...
        	 startActivity(new Intent(ResultDisplay.this,
		                ImageActivity.class));
         ...
         case R.id.Continue:   
			 ...
			 Uri imUri = getIntent().getParcelableExtra("imageUri");
			 Intent intent2 = new Intent(ResultDisplay.this, Fin.class);
